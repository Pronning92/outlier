...
# Modified by Venkata Yellapantula on Aug 3rd 2016
...
#### This block scales the data frame with column sums ######
col1=expTab[,1]
geneNameRm=expTab[,-1]
geneNameRm=sweep(geneNameRm, 2, colSums(geneNameRm), FUN="/")
geneNameRm=cbind(col1,geneNameRm)
colnames(geneNameRm)=colnames(expTab)
expTab=geneNameRm
